...
the Paste to Markdown community a harassment-free experience for everyone,
...
The project maintainer is responsible for clarifying and enforcing this Code of
Conduct and may take fair, appropriate, and proportionate corrective action in
...
reported privately to the project maintainer through a private GitHub reporting
or contact path when one is available. If no private path is available, open a
minimal issue requesting private follow-up without posting incident details
publicly.

Please do not use public issue or pull request arguments to handle Code of
Conduct reports. Reports will be reviewed and investigated promptly and fairly,
with respect for the privacy and security of the reporter and others involved.
