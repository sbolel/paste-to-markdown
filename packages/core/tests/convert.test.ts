...
describe('convertHtmlToMarkdown', () => {
  ...
  it('converts links', () => {
    const result = convertHtmlToMarkdown('<a href="https://example.com">Example</a>');
  ...
  it('converts blockquotes', () => {
    const result = convertHtmlToMarkdown('<blockquote><p>Quote text</p></blockquote>');
  ...
  it('converts nested lists', () => {
    const html = '<ul><li>Item 1<ul><li>Nested</li></ul></li><li>Item 2</li></ul>';
    const result = convertHtmlToMarkdown(html);
